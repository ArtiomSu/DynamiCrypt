...
${OBJECTDIR}/_ext/8cd854a2/API_service.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/API_service.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8cd854a2/API_service.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/API_service.cpp
...
${OBJECTDIR}/_ext/8cd854a2/SingleTpmNetworkHandler.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/SingleTpmNetworkHandler.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8cd854a2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8cd854a2/SingleTpmNetworkHandler.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/SingleTpmNetworkHandler.cpp
...
${OBJECTDIR}/_ext/8cd854a2/System_Helper.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/System_Helper.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8cd854a2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8cd854a2/System_Helper.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/System_Helper.cpp
...
${OBJECTDIR}/_ext/8cd854a2/TpmNetworkHandler.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/TpmNetworkHandler.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8cd854a2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8cd854a2/TpmNetworkHandler.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/TpmNetworkHandler.cpp
...
${OBJECTDIR}/_ext/8cd854a2/definitions.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/definitions.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8cd854a2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8cd854a2/definitions.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/definitions.cpp
...
${OBJECTDIR}/_ext/8cd854a2/peer.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/peer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8cd854a2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8cd854a2/peer.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCrypt/peer.cpp
