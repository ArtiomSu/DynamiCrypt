...
LDLIBSOPTIONS=-lpthread -lboost_system -lboost_thread -lboost_program_options -lcryptopp
...
${OBJECTDIR}/_ext/9a0c25d/SingleTpmNetworkHandler.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/SingleTpmNetworkHandler.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9a0c25d/SingleTpmNetworkHandler.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/SingleTpmNetworkHandler.cpp
...
${OBJECTDIR}/_ext/9a0c25d/System_Helper.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/System_Helper.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/9a0c25d
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9a0c25d/System_Helper.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/System_Helper.cpp
...
${OBJECTDIR}/_ext/9a0c25d/TpmNetworkHandler.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/TpmNetworkHandler.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/9a0c25d
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9a0c25d/TpmNetworkHandler.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/TpmNetworkHandler.cpp
...
${OBJECTDIR}/_ext/9a0c25d/definitions.o: /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/definitions.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/9a0c25d
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9a0c25d/definitions.o /media/veracrypt1/CollegeSyncUnison/FYP/code/Dynamicrypt/git/DynamiCrypt/DynamiCryptSync/definitions.cpp
